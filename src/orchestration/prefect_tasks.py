...
def agents_pipeline(day: str):
    ...
    try:
        ...
        logger.error(f"Agents pipeline failed: {e}")
        raise
...
def roles_pipeline(day: str):
    ...
    try:
        ...
        logger.error(f"Roles pipeline failed: {e}")
        raise
...
def agent_roles_pipeline(day: str):
    ...
    try:
        ...
        logger.error(f"Agent roles pipeline failed: {e}")
        raise
...
def groups_pipeline(day: str):
    ...
    try:
        ...
        logger.error(f"Groups pipeline failed: {e}")
        raise
...
def budgets_pipeline(day: str):
    ...
    try:
        ...
        logger.error(f"Budgets pipeline failed: {e}")
        raise
...
def cards_pipeline(day: str):
    ...
    try:
        ...
        logger.error(f"Cards pipeline failed: {e}")
        raise
...
def transactions_pipeline(day: str):
    ...
    try:
        ...
        logger.error(f"Transactions pipeline failed: {e}")
        raise
